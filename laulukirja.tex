...
\newcommand{\footerbits}[1]{\scriptsize \input{footer/binary\arabic{BitsCounter}}\stepcounter{BitsCounter}}
...
\fancyfoot[LE]{\small\thepage\ \footerbits{}}
\fancyfoot[RO]{\footerbits{}\ \small\thepage}
